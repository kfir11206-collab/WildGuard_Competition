...
Orientation for future sessions — what each top-level directory is for:

- `nano_llm/` and `classifier/` — the **legacy project** we are based on.
- `jetson-containers/` — dusty-nv's Jetson containers, used for installation and running. We are **building locally for version 39** because dusty-nv does not support JetPack 7+.
- `hf-cache/` — the Hugging Face cache.
